---
description: |
  The magalucloud Packer builder is able to create images for use with
  Magalu Cloud Virtual Machines based on existing images.
page_title: Magalu Cloud - Builders
sidebar_title: Magalu Cloud
---

# Magalu Cloud Builder
